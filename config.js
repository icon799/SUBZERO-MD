...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~yLAzsZFoFkQgpVvOp89t",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || ".",         // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "𝕋𝕙𝕖𝕖𝕔𝕠𝕟𝕚𝕔",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "254716664476",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "𝕄𝕣 𝕀ℂ𝕆ℕ",           // Owner's name
    ...
    BAILEYS: process.env.BAILEYS || "@shizodevs/baileys",  // Subzero Bot's BAILEYS
};
